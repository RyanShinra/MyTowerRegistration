...
public class UserMutationTests
{
    ...
    //       _mockRepo.Setup(r => r.UsernameExistsAsync(It.IsAny<string>()))
    //           .ReturnsAsync(false);
    ...
    //       var result = await _mutations.RegisterUser(input, _mockRepo.Object);
    //
    //       // Assert
    ...
    //       _mockRepo.Setup(r => r.UsernameExistsAsync("taken"))
    //           .ReturnsAsync(true);
    //
    ...
    //       Assert.Equal("USERNAME_TAKEN", result.Errors![0].Code);
    //
    ...
    //       _mockRepo.Setup(r => r.UsernameExistsAsync(It.IsAny<string>()))
    //           .ReturnsAsync(false);
    //       _mockRepo.Setup(r => r.EmailExistsAsync("taken@example.com"))
    //           .ReturnsAsync(true);
    //
    ...
    //       _mockRepo.Verify(r => r.UsernameExistsAsync(It.IsAny<string>()), Times.Never);
    //   }
    ...
    //
    //       await _mutations.RegisterUser(input, _mockRepo.Object);
    //
